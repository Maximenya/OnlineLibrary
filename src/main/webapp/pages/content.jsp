...
<div style="margin:30px;">
    <a href="books.jsp"><< вернуться</a>
        ...
        <div class="pdf_viewer">
            <applet CODE="EmbedPDF.class" archive="../jars/EmbedPDF.jar" WIDTH="850" HEIGHT="900">
                <!-- The URL of the PDF document that we want to show: -->

                <param name="pdf" value="/PdfContent?index=<%=request.getParameter("index")%>&session_id=<%=request.getSession().getId()%>"/>
                ...
                <param name="image" value="../images/splash.gif"/>
